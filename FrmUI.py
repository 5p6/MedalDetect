...
"}")
        ...
        self.label.setGeometry(QtCore.QRect(490, 260, 281, 50))
        self.label.setWordWrap(True)
        self.label.setObjectName("label")
        self.labelTitle = QtWidgets.QLabel(self.loginWin)
        self.labelTitle.setGeometry(QtCore.QRect(500, 39, 241, 41))
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        ...
        self.pushButtonReg.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
    ...
    def retranslateUi(self, frmMain):
        ...
        # self.label.setText(_translate("frmMain", "<html><head/><body><p>我已认真审阅并同意<span style=\"color:blue;\">客户使用规范内容及相关协议及法律规定</span></p></body></html>"))
        self.labelTitle.setText(_translate("frmMain", "金属表面缺陷检测系统登录"))
        font = QFont()
        font.setFamily("微软雅黑")
        font.setPointSize(10)  # 设置字体大小为 18
        self.labelTitle.setFont(font)
